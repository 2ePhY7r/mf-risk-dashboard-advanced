...
with col_left:
    ...
    st.plotly_chart(fig_imp, use_container_width=True, key="feat_importance_chart")
...
with col_right:
    ...
    st.plotly_chart(fig_scatter, use_container_width=True, key="metabolic_scatter_chart")
...
search_id = st.selectbox("Select Customer ID for Audit:", options=display_df['customer_id'].head(100), key="audit_customer_select")
